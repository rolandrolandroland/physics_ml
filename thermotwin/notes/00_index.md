...
| [13 — Measurement imperfections](13_measurement_imperfections.md) | Consolidate temperature noise, sensor bias, sensor lag, deterministic missingness, transformation order, sparse accessible-sensor inference, grid-node artifacts, local polish, and identifiability | Not started |
